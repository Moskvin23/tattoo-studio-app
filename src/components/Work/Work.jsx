      ...
      <div className="container">
        <div className="work-content">
          <div className="section-title">
            ...
            <p className="text">
              Tattooing is the art of painting on the body. Large or small, black and white or
              color, unique and individual tattoos can be created by our studio tattoo artists.
            </p>
          </div>
